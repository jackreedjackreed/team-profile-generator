...
const fef = new Manager("mam", "4", "@", "Manager", "333")
const ses = new Engineer("erf", "3", "@", "Engineer", "111")
const tet = new Intern("rer", "2", "@", "Intern", "333")
const wew = new Employee("wew", "5", "@", "Employee")

const html = [];

const team = [fef, tet, wew, ses];
...
// console.log(generateEmployee(wew))

console.log(makeTeam(team));
